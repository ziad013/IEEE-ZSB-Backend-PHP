            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="./" aria-current="page" class=" <?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300' ;  ?>  hover:bg-white/5 hover:text-white">Home</a>
                        <a href="./about.php" class="<?= urlIs('/about.php')  ? 'bg-gray-900 text-white' : 'text-gray-300' ;  ?> hover:bg-white/5 hover:text-white">About</a>
                        <a href="./contact.php" class="<?= urlIs('/contact.php')  ? 'bg-gray-900 text-white' : 'text-gray-300' ;  ?> hover:text-white">Contact</a>
